 ...
 class TweetPHP {
    ...
    public function  __construct ($options = array()) {
      ...
      array(
          ...
          'access_token_secret'   => '',
          'twitter_screen_name'   => '',
          'cache_file'            => dirname(__FILE__) . '/TweetPHP/cache/twitter.txt', // Where on the server to save the cached formatted tweets
          'cache_file_raw'        => dirname(__FILE__) . '/TweetPHP/cache/twitter-array.txt', // Where on the server to save the cached raw tweets
    ...
    private function fetch_tweets () {
      ...
      require_once(dirname(__FILE__) . '/TweetPHP/tmhOAuth/tmhOAuth.php');
    ...
    public function autolink ($tweet) {
      require_once(dirname(__FILE__) . '/TweetPHP/twitter-text-php/lib/Twitter/Autolink.php');
